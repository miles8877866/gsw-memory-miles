...
{background_context}
  ...
  1) Atomic entities
  - Input: ?bisoft? Assassin? Creed was announced on 29 October 1923 via New York Times with the request of US government.??  - Do: Entities ?bisoft??(organization), ?ssassin? Creed??(title/work), ??9 October 1923??(date), ?ew York Times??(media), ?S government??(government). Phrase: ?nnounced??
  - Don?: Single entity ?bisoft? Assassin? Creed?? DO NOT pass any entity can be bundled into a single entity.

  2) Temporal rules (no fabrication)
  - Input: "On 29 October 1923, Parliament passed the Green Act."
  - Do: Entity ??9 October 1923?? Connect via an event/action: <Green Act> ???ccurred during??????9 October 1923??

  3) Abbreviation & alias
  - Input: ?erman Aerospace Center (DLR) led the study.??  - Do: Entities ?erman Aerospace Center (DLR)??(org) and ?LR??(alias); phrase ?lso known as??
  - Don?: Expand ?N??to ?nited Nations??if only ?N??appears.

  4) Two questions + complete content and recipient
  - Input: ?inance Minister Harald Jensen announced to Parliament that the budget would increase on May 19, 1919.??  - Do: Create proposition ?he budget would increase?? add phrases with exactly one unknown per question:

    - ?nnounced to ... that??(recipient is the unknown):
      - A?: To whom did Finance Minister Harald Jensen announce **that the budget would increase on May 19, 1919**?
      - B?: Who announced to Parliament **that the budget would increase on May 19, 1919**?
    - ?nnounced that ... to??(content is the unknown):
      - A?: What did Finance Minister Harald Jensen announce to Parliament on May 19, 1919?
      - B?: Who announced **that the budget would increase on May 19, 1919**?
    - ?nnounced on ... to ... that??(date/time is the unknown):
      - A?: When did Finance Minister Harald Jensen announce to Parliament **that the budget would increase**?
      - B?: What did Finance Minister Harald Jensen announce to Parliament **on May 19, 1919**?
      
    - **DO NOT** omit the **that** content in any question.


  5) Question format + IDs only
  - Input: ?n 29 October 1923, Parliament passed the Green Act.??  - Do: ?assed?? A? ?ho passed the Green Act on 29 October 1923???/ B? ?hat did Parliament pass on 29 October 1923??? answers are IDs.
  - Don?: ?ho passed it???or answers with names.

  6) Universal object/content capture
  - Input: ?he architect built the museum.??  - Do: ?uilt??(agent?bject) and ?uilt by??(object?gent).
  - Input: ?he minister reported to Cabinet that taxes would rise.??  - Do: ?eported to??(recipient) and ?eported that??(proposition).

  7) Authority/leadership context
  - Input: ?arliament passed the Green Act over President Henry Wallace? veto.??  - Do: ?ver veto of?? and ?n office during??

  8) Special relationships (conditionality, purpose, temporal, comparative)
  - Conditional: ??would join NATO if forces were reorganized.?????onditional on??
  - Purpose: ??launched reforms to reduce inflation.????proposition ?educe inflation?? ?or purpose??
  - Temporal: ??after elections.????temporal qualifier ?fter??

  9) Complete content capture
  - Input: ?he CEO announced that the company would expand operations after securing funding.??  - Do: Proposition includes ?fter securing funding??

  10) Entity completeness
  - Input: ?ongress voted on the controversial tax reform bill.??  - Do: Entity ?ontroversial tax reform bill??so answers can reference it by ID.
  ...
  **Input:**  
  "Clara of Verden (d. 5 April 910) was the daughter of Otto of Saxony, a member of the Brunonen family. In June 889, she married King Rudolf II of Burgundy (880??37) in Lausanne."
  ...
  **Input:**  
  "On 12 May 1955, Prime Minister Harald Jensen reported to Parliament that he would support joining NATO if Denmark? defense forces were reorganized under a new command.??
  **Output:**
  ```json
  {{
    "entity_nodes": [
  ...
  **Input:**  
  "On 2 March 1923, Parliament passed the Green Act, over President Henry Wallace? veto."
  ...
  **Input:**  
  ...
  The screenplay was written by Jordan Quinn, who also wrote the ?ity of Glass??arc in the monthly Vigil Comics series."
  ...
  **Key Instructions:**
  ...
  3. **Generate bidirectional questions**: Always create questions from both directions:
    ...
    - QA inversion: If the A? question contains entity A and its answers are the IDs of entity B, then the B? question must contain entity B and its answers must be the IDs of entity A. The two questions must swap sides; do not repeat the same side in both questions??texts or answers.
    
  4. **No pronouns in questions or uncertain objects in questions.**
    - Input: ?ichael Jackson stated that his verses are about the convict life in Brasil in his song Care About US??    - Do: Who talked about the convict life in Brasil in his song Care About US?
    - Don?: Who talked about the convict life in Brasil in his song?
