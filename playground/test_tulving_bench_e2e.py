...
def load_tulving_bench_data():
    ...
    book_path = os.path.join(base_dir, "src", "gsw_memory", "benchmarks", "tulvingbench", "book_20.json")
    ...
    # Load questions
    questions_path = os.path.join(base_dir, "src", "gsw_memory", "benchmarks", "tulvingbench", "questions_20.json")
...
def evaluate_with_tulving_bench(evaluation_data):
    ...
    evaluator = TulvingBenchEvaluator(
        model_name="gemini/gemini-2.0-flash", generation_params={"temperature": 0.0}
    )
